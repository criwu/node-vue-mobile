    ...
    <el-form label-width="120px" @submit.native.prevent="save">
      <!--  <el-form-item label="上级分类">
        <el-select v-model="model.parent">
          <el-option :key="item.id" v-for="item in parents" :label="item.name" :value="item._id"></el-option>
        </el-select>
      </el-form-item>-->
      <el-tabs type="border-card" value="skills">
        <el-tab-pane label="基础信息">
          ...
          <el-form-item label="技能">
            <el-rate v-model="model.scores.skill" :max="9" show-score style="margin-top:0.7rem"></el-rate>
          </el-form-item>
